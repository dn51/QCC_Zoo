...
.method moveToState(Landroidx/fragment/app/Fragment;IIIZ)V
    ...
    if-eq v1, v9, :cond_1f9

    if-eq v1, v11, :cond_2f6
    ...
    move-result-object v0
    :try_end_25f
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_255 .. :try_end_25f} :catch_260
    ...
    if-le v1, v0, :cond_525

    .line 929
    iget v1, v8, Landroidx/fragment/app/Fragment;->mState:I

    if-eq v1, v9, :cond_448

    const/4 v2, 0x2

    if-eq v1, v2, :cond_39a
