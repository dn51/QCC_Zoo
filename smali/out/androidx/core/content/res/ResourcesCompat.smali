...
.method private static loadFont(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    move-result v0
    :try_end_3f
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_35 .. :try_end_3f} :catch_d8
    .catch Ljava/io/IOException; {:try_start_35 .. :try_end_3f} :catch_bd
    ...
    :try_end_4a
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_41 .. :try_end_4a} :catch_92
    .catch Ljava/io/IOException; {:try_start_41 .. :try_end_4a} :catch_8b
    ...
    invoke-virtual {v13, v7, v14}, Landroidx/core/content/res/ResourcesCompat$FontCallback;->callbackFailAsync(ILandroid/os/Handler;)V
    :try_end_58
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_4e .. :try_end_58} :catch_61
    ...
    move-result-object v1
    :try_end_81
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_7d .. :try_end_81} :catch_86
    ...
    move-result-object v0
    :try_end_a2
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_9e .. :try_end_a2} :catch_bb
    .catch Ljava/io/IOException; {:try_start_9e .. :try_end_a2} :catch_b9
    ...
    :try_end_af
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_a7 .. :try_end_af} :catch_b4
