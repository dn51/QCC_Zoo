...
.method private static addCommand(Landroid/graphics/Path;[FCC[F)V
    ...
    sparse-switch v11, :sswitch_data_3fe
    ...
    if-eq v11, v0, :cond_39f

    const/16 v0, 0x43

    if-eq v11, v0, :cond_368

    const/16 v2, 0x48

    if-eq v11, v2, :cond_356

    const/16 v2, 0x51

    if-eq v11, v2, :cond_328

    const/16 v3, 0x56

    if-eq v11, v3, :cond_316

    const/16 v3, 0x61

    if-eq v11, v3, :cond_2bf

    const/16 v3, 0x63

    if-eq v11, v3, :cond_285
    ...
    if-eq v11, v4, :cond_244

    const/16 v5, 0x76

    if-eq v11, v5, :cond_233
    ...
    if-eq v11, v1, :cond_1ec

    const/16 v1, 0x53

    const/high16 v5, 0x40000000    # 2.0f

    if-eq v11, v1, :cond_1a0

    const/16 v15, 0x54

    if-eq v11, v15, :cond_16f

    const/16 v5, 0x6c

    if-eq v11, v5, :cond_155

    const/16 v5, 0x6d

    if-eq v11, v5, :cond_124

    const/16 v5, 0x73

    if-eq v11, v5, :cond_d5
    ...
    .line 589
    .local v1, "reflectiveCtrlPointY":F
    if-eq v14, v4, :cond_17c

    const/16 v3, 0x74

    if-eq v14, v3, :cond_17c

    if-eq v14, v2, :cond_17c
    ...
    if-eq v14, v3, :cond_1b2

    const/16 v3, 0x73

    if-eq v14, v3, :cond_1b2

    if-eq v14, v0, :cond_1b2

    if-ne v14, v1, :cond_1ae
